    ...
    <div className="min-h-screen p-10 bg-gray-50">
      <div className="flex gap-10 ">
        <div className="p-6 m-auto bg-white rounded-lg shadow-md">
          ...
          <div className='flex flex-wrap w-full gap-2'>
            {
              icon_filter.map((item) => (
                <div className='flex items-center gap-2 px-4 py-2 text-blue-500 bg-blue-200 rounded-lg w-fit'>
                  {
                    item.icon
                  }
                  {
          ...
          <img src="https://standarthotel.com/upload/iblock/1ea/1eaaf3d47deeafcff9b1931a8fad2dc1.jpg" alt="Room" className="w-full py-2 rounded-lg" />
        </div>
        <div className="p-6 bg-white rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold">Выберите дату</h2>
          <Calendar className="p-2 mt-4 border rounded-lg" />
      ...
      <div className="mt-10">
        <div className="relative flex items-center">
          <button onClick={() => setIsOpen(true)} className="px-4 py-2 font-semibold text-left text-blue-500 bg-blue-200 rounded-lg">
            Оставить отзыв
          </button>
          <h2 className="absolute flex-grow text-2xl font-semibold text-center top-1/2 left-1/2 -translate-2/4">Отзывы</h2>
        </div>
