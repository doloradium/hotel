        ...
        <AnimatePresence>
            {
                ...
                <motion.div
                    ...
                    className="fixed top-0 left-0 flex items-center justify-center w-full h-screen z-2 bg-black/50"
                >
                    <motion.div
                        initial={{ y: '10%' }}
                        animate={{ y: '0%' }}
                    ...
                    >
                        <button onClick={() => setIsOpen(false)} className="absolute text-gray-500 top-3 right-3 hover:text-black">
